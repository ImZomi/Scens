...
public class Main extends JavaPlugin{
    ...
    public static Boolean Timber = Boolean.valueOf(false);
    public static Boolean CutClean = Boolean.valueOf(false);
    public static Boolean HasteyBoys = Boolean.valueOf(false);
